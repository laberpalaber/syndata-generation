...
python dataset_generator.py  --dontocclude --selected --scale --rotation --num 8 /home/IIT.LOCAL/ebunz/mask_rcnn/syndata-generation/demo_data_dir/YCB_objects_split_20k/train/ /home/IIT.LOCAL/ebunz/mask_rcnn/syndata-generation/dataset_20k_train_noOcclusions_smallScale_new defaults_20k_train_noOcclusions_smallScale_new.py

# Convert training to binary
echo "Convert training to binary"
python convert_dataset_to_binary.py dataset_20k_train_noOcclusions_smallScale_new

# Convert training binary to COCO
echo "Convert training binary to COCO"
python ycb_to_coco_parallel_py2.py dataset_20k_train_noOcclusions_smallScale_new
...
python dataset_generator.py  --dontocclude --selected --scale --rotation --num 8 /home/IIT.LOCAL/ebunz/mask_rcnn/syndata-generation/demo_data_dir/YCB_objects_split_20k/val/ /home/IIT.LOCAL/ebunz/mask_rcnn/syndata-generation/dataset_20k_val_noOcclusions_smallScale_new defaults_20k_val_noOcclusions_smallScale_new.py

# Convert validation to binary
echo "Convert validation to binary"
python convert_dataset_to_binary.py dataset_20k_val_noOcclusions_smallScale_new

# Convert validation binary to COCO
echo "Convert validation binary to COCO"
python ycb_to_coco_parallel_py2.py dataset_20k_val_noOcclusions_smallScale_new
