...
MIN_SCALE = 1 # min scale for scale augmentation
MAX_SCALE = 1.8 # max scale for scale augmentation
...
MIN_X_POSITION = 50 # Define a rectangular area in the image where objects will end up in
MIN_Y_POSITION = 50
MAX_X_POSITION = 590
MAX_Y_POSITION = 430
