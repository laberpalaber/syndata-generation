...
python dataset_generator.py  --dontocclude --selected --num 8 /home/IIT.LOCAL/ebunz/mask_rcnn/syndata-generation/demo_data_dir/YCB_objects_split_20k/val/ /home/IIT.LOCAL/ebunz/mask_rcnn/syndata-generation/dataset_20k_val_smallScale defaults_20k_val_smallScale.py

# Convert validation to binary
echo "Convert validation to binary"
python convert_dataset_to_binary.py dataset_20k_val_smallScale

# Convert validation binary to COCO
echo "Convert validation binary to COCO"
python ycb_to_coco_parallel_py2.py dataset_20k_val_smallScale
...
#python dataset_generator.py  --dontocclude --selected --num 8 /home/IIT.LOCAL/ebunz/mask_rcnn/syndata-generation/demo_data_dir/YCB_objects_split_20k/train/ /home/IIT.LOCAL/ebunz/mask_rcnn/syndata-generation/dataset_20k_train_smallScale defaults_20k_train_smallScale.py

# Convert training to binary
#echo "Convert training to binary"
#python convert_dataset_to_binary.py dataset_20k_train_smallScale

# Convert training binary to COCO
#echo "Convert training binary to COCO"
#python ycb_to_coco_parallel_py2.py dataset_20k_train_smallScale
